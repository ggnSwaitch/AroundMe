...
open class ARViewController: UIViewController, ARTrackingManagerDelegate
{
    ...
    internal func initializeInternal()
    {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ARViewController.appWillEnterForeground(_:)), name: NSNotification.Name.UIApplication.willEnterForegroundNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(ARViewController.appDidEnterBackground(_:)), name: NSNotification.Name.UIApplication.didEnterBackgroundNotification, object: nil)
        self.initialize()
    }
